...
#else
static char _WlzInterpolateSectionViewerBibFiles_c[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         binWlzApp/WlzInterpolateSectionViewerBibFiles.c
* \author       Jianguo Rao
* \date         August 2002
* \version      $Id$
* \par
...
* \brief 	Automatically interpolates bib files.
* \ingroup	BinWlzApp
*
* \par Binary
* ref wlzinterpolatesectionviewerbibfiles "WlzInterpolateSectionViewerBibFiles"
*/

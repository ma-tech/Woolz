...
#else
static char _WlzTensorToVtk_c[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         binWlzApp/WlzTensorToVtk.c
* \author       Angus Murray
* \date         September 2005
* \version      $Id$
* \par
...
* \brief	Converts a tensor object to VTK format.
* \ingroup	WlzBinApp
*
* \par Binary
* ref wlztensortovtk "WlzTensorToVtk"
*/

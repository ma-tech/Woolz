...
#else
static char _WlzIndexObjToCompound_c[] = "MRC HGU $Id$";
#endif
#endif
/*!
...
*
* \par Binary
* \ref wlzindexobjfromcompound "WlzIndexObjToCompound"
*/

/*!
\ingroup BinWlz
\defgroup wlzindexobjfromcompound WlzIndexObjToCompound
\par Name

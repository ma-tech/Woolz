...
#else
static char _WlzAutoTrackUpDown_c[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         binWlz/WlzAutoTrackUpDown.c
...
* \brief	Tracks a boundary up and down from the defined planes.
* \ingroup	BinWlz
*
* \par Binary
* \ref wlzautotrackupdown "WlzAutoTrackUpDown"
*/
#include <stdio.h>
#include <stdlib.h>
#include <math.h>

...
#else
static char _WlzMatchICP_c[] = "University of Edinburgh $Id$";
#endif
/*!
* \file         libWlz/WlzMatchICP.c
* \author       Bill Hill
* \date         August 2001
* \version      $Id$
* \par
...
* \brief	Functions to match objects using ICP based registration,
* 		providing a set of corresponding points.

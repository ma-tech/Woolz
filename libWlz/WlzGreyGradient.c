...
#else
static char _WlzGreyGradient_c[] = "University of Edinburgh $Id$";
#endif
/*!
...
* \brief	Computes objects in which the grey values are the
* 		gradient of the gray values in the original image.

...
* \ingroup	WlzConvexHull
* \brief	Fill in parameters of the convex hull into the values table.
* 		This function is only called after a successful call to
* 		WlzObjToConvexPolygon therefore the given convex hull
* 		object and object have been checked and are known to match.
* \param	cvh			Given convex hull.
* \param	obj			Given object.
* \param	dstErr			Destination error pointer, may be NULL.
*/
